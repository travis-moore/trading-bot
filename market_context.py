...
class MarketRegimeDetector:
    ...
    def assess_regime(self) -> MarketRegime:
        ...
        try:
            ...
            vix_bars = self.ib.get_historical_bars('VIX', bar_size='1 day', duration='30 D', exchange='CBOE')
            ...
            if vix_change_pct > 0.20 or spy_vol > 0.02 or current_vix > 30:
                regime = MarketRegime.HIGH_CHAOS
                
            # Bear Trend: SPY < 200 MA OR VIX > 30
            elif current_spy < sma_200 or current_vix > 30:
                regime = MarketRegime.BEAR_TREND
                
            # Range Bound: SPY range < 2% AND VIX stable (15-25)
            elif spy_range_pct < 0.02 and 15 <= current_vix <= 25:
                regime = MarketRegime.RANGE_BOUND
                
            # Bull Trend: SPY > 200 MA AND VIX < 20
            elif current_spy > sma_200 and current_vix < 20:
